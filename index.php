		      ...
		      <div id="revolution-slider-half">
		        <ul>
		          ...
		          <li data-transition="random" data-slotamount="10" data-masterspeed="1200" data-delay="5000">
		            ...
		            <div class="tp-caption slide-big-heading sft" data-x="center" data-y="160" data-speed="800" data-start="400" data-easing="easeInOutExpo" data-endspeed="450">
		              <span style="color:#fd9b28;"> best of</span> business planning <BR>advisor & specialist
		            </div>

		            <div class="tp-caption btn-slider sfb" data-x="center" data-y="300" data-speed="400" data-start="800" data-easing="easeInOutExpo">
		    ...
		    <div class="row">
		      ...
		      <div class="col-md-4 col-sm-6 col-xs-12">
		        <div class="we-do-item">
		          ...
		          <div class="we-desc">
		            <h4 class="we-title">Travel and Aviation Consulting</h4>
	  ...
	  text_align_left has_icon  mb-3">
		          <h4 style="font-size:31px;color: #ffffff;line-height:37px;text-align:center" class="consulting-custom-title"><mark>Busines</mark> &amp; cumminatin skill</h4>
		        </div>
		      </div>
		          ...
		          <div class="accordion" id="faq">
		            <div class="card">
		              <div class="card-header" id="faqhead1">
		                <a href="#" class="btn-header-link text-truncate" data-toggle="collapse" data-target="#faq1" aria-expanded="true" aria-controls="faq1">What does Consulting WP do</a>
		              </div>
		            ...
		            <div class="card">
		              <div class="card-header" id="faqhead2">
		                <a href="#" class=" btn-header-link text-wrap collapsed" data-toggle="collapse" data-target="#faq2" aria-expanded="true" aria-controls="faq2">Which geographies you have worked already?</a>
		              </div>
		            ...
		            <div class="card">
		              <div class="card-header" id="faqhead3">
		                <a href="#" class=" btn-header-link text-wrap collapsed" data-toggle="collapse" data-target="#faq3" aria-expanded="true" aria-controls="faq3">What makes you special from others?</a>
		              </div>
		    ...
		    <div class="row">
		      <div class="col-md-12">
		        <div class="vc_custom_heading text_align_center">
		          <h4 style="font-size: 28px;color: #ffffff;line-height: 34px;text-align: center" class="consulting-custom-title">To help entrepreneurs get their act together<br>
